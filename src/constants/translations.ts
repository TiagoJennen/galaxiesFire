export const translations = {
  nl: {
    ...
    subtaskDescription: "Beschrijving subtaak",
    subtaskDescriptionPlaceholder: "Leg uit wat deze subtaak precies inhoudt.",
  ...
  en: {
    ...
    subtaskDescriptionPlaceholder: "Clarify what this subtask should cover.",
